...
const LocationCard = () => {
    ...
    useEffect(() => {
        ...
        const globe = createGlobe(canvasRef.current, {
            ...
            markers: [{ location: [43.4643, -80.5204], size: 0.1 }],
            scale: 1.05,
            onRender: (state) => {
    ...
    return (
        <div className="shadow-feature-card dark:shadow-feature-card-dark relative flex h-60 flex-col gap-6 overflow-hidden rounded-xl p-4 lg:p-6">
            <div className="flex items-center gap-2">
                ...
                <h2 className="text-base font-bold">Waterloo, Ontario</h2>
            </div>
                        ...
                        <canvas
                            ...
                            onMouseMove={(e) => {
                                if (pointerInteracting.current !== null) {
                                    ...
                                    api.start({ r: delta / 200 }); // Explicitly calling start to handle the return
                                }
                            }}
                            onTouchMove={(e) => {
                                if (pointerInteracting.current !== null && e.touches[0]) {
                                    ...
                                    pointerInteractionMovement.current = delta;
                                    api.start({ r: delta / 100 }); // Explicitly calling start to handle the return
                                }
                            }}
                            style={{
                                width: "100%",
